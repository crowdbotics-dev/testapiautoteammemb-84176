...
## Project Structure
    ...
    ├── testapiautoteammemb_84176  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_84176`
...
2. Clone this repo and `cd testapiautoteammemb_84176`
